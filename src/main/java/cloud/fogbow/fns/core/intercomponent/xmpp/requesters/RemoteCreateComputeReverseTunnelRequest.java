...
public class RemoteCreateComputeReverseTunnelRequest implements RemoteRequest<Void> {
    private static final Logger LOGGER = Logger.getLogger(RemoteCreateComputeReverseTunnelRequest.class);

    private String targetMember;
    private FederatedNetworkOrder order;

    public RemoteCreateComputeReverseTunnelRequest(String targetMember, FederatedNetworkOrder order) {
    ...
    public Void send() throws Exception {
        IQ iq = RemoteCreateComputeReverseTunnelRequest.marshal(this.targetMember, this.order);
    ...
    public static IQ marshal(String targetMember, FederatedNetworkOrder order) {
        ...
        Element queryElement = iq.getElement().addElement(IqElement.QUERY.toString(), RemoteMethod.REMOTE_CREATE_COMPUTE_REVERSE_TUNNEL.toString());
