...
public class RemoteGetDfnsAgentConfigurationRequestHandler extends AbstractQueryHandler {
    ...
    public IQ handle(IQ iq) {
        ...
        try {
            SSAgentConfiguration dfnsAgentConfiguration = RemoteFacade.getInstance().getDfnsAgentConfiguration();
    ...
    private void updateResponse(IQ response, SSAgentConfiguration dfnsAgentConfiguration) {
