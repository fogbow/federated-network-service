...
public class RemoteRemoveComputeReverseTunnelRequest implements RemoteRequest<Void> {
    private static final Logger LOGGER = Logger.getLogger(RemoteRemoveComputeReverseTunnelRequest.class);

    private String targetMember;
    private FederatedNetworkOrder order;

    public RemoteRemoveComputeReverseTunnelRequest(String targetMember, FederatedNetworkOrder order) {
    ...
    public Void send() throws Exception {
        IQ iq = RemoteRemoveComputeReverseTunnelRequest.marshal(this.targetMember, this.order);
    ...
    public static IQ marshal(String targetMember, FederatedNetworkOrder order) {
        ...
        Element queryElement = iq.getElement().addElement(IqElement.QUERY.toString(), RemoteMethod.REMOTE_REMOVE_COMPUTE_REVERSE_TUNNEL.toString());
