...
public class RemoteCreateComputeReverseTunnelRequestHandler extends AbstractQueryHandler {
    public RemoteCreateComputeReverseTunnelRequestHandler() {
        super(RemoteMethod.REMOTE_CREATE_COMPUTE_REVERSE_TUNNEL.toString());
    }
    ...
    public IQ handle(IQ iq) {
        ...
        try {
            RemoteFacade.getInstance().createComputeReverseTunnel(order);
