...
public class FederatedNetworkUtilTest extends BaseUnitTest {
    ...
    public void testGetFreeIp() throws SubnetAddressesCapacityReachedException, InvalidCidrException {
        ...
        int ipsServed = 1;
        FederatedNetworkOrder federatedNetwork = spy(new FederatedNetworkOrder(user, cidr,
    ...
    public void testNetworkOverflow() throws InvalidCidrException {
        ...
        String cidr = "10.0.0.0/24";
        int ipsServed = 254;
        FederatedNetworkOrder federatedNetwork = new FederatedNetworkOrder(user, cidr,
                "label", allowedMembers, ipsServed, freedIps, computesIp);
        //exercise
        try {
    ...
    public void testInvalidNetworkCidr() {
        ...
        int ipsServed = -1;
        FederatedNetworkOrder federatedNetwork = new FederatedNetworkOrder(user, malformedCidr,
                "label", allowedMembers, ipsServed, freedIps, computesIp);
