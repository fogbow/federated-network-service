...
public class FederatedNetworkOrderControllerTest extends BaseUnitTest {
    ...
    private FederatedNetworkOrdersHolder federatedNetworkOrdersHolder;
...
//        assertEquals(newId, federatedCompute.getId());
    ...
    @Test
    public void testGetFederatedCompute() throws SQLException {
        //set up
        mockOnlyDatabase();
...
//        }
    ...
    @Test
    public void testGetNotFederatedCompute() throws SQLException {
        //set up
        mockSingletons();
        List<String> ipAddresses = new ArrayList<>();
        ipAddresses.add("192.168.0.2");
...
//        assertFalse(federatedComputeInstance instanceof FederatedComputeInstance);
    ...
    @Test
    public void testDeleteFederatedCompute() throws SQLException {
        //set up
        mockOnlyDatabase();
        addNetworkIntoActiveOrdersMap();
        addComputeIntoActiveOrdersMap();
...
//        assertTrue(federatedNetwork.getComputeIdsAndIps().isEmpty());
    ...
    @Test
    public void testRemoveNonFederatedCompute() throws SQLException {
        //set up
        mockOnlyDatabase();
        addNetworkIntoActiveOrdersMap();
        Collection<FederatedNetworkOrder> orders = federatedNetworkOrdersHolder.getActiveOrdersMap().values();
...
//        }
    ...
    private void mockDatabase(Map<String, FederatedNetworkOrder> activeOrdersMap) throws SQLException {
